...
#define MTK_GATT_JITTER_TEST

// this macro is just for CI system auto test, you can remove it if you don't need
#define MTK_BT_EXTRA_CLI_TEST
...
/* For BT LE scan list, would create a link list to store adv report of LE scan. */
#define BT_UT_GAP_LE_SCAN_LIST
