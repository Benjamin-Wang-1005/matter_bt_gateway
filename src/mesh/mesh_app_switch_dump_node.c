...
void mesh_app_get_composition_data(void);
void mesh_app_get_model_publication(void);
void mesh_app_get_model_subscription(void);
void mesh_app_get_model_app(void);
void mesh_app_get_net_key(void);
void mesh_app_get_default_ttl(void);
void mesh_app_get_network_transmit(void);
void mesh_app_get_relay(void);
void mesh_app_get_beacon(void);
void mesh_app_get_heartbeat_publication(void);
void mesh_app_get_heartbeat_subscription(void);
void mesh_app_get_node_identity(void);
void mesh_app_get_app_key(void);
void mesh_app_get_lpn_poll_timeout(void);
extern void mesh_app_post_timeout_event(TimerHandle_t timer_id);
...
void mesh_app_get_composition_data()
{
    if (gConfigureRetry > 0) {
        ...
        LOG_I(mesh_app, "stop retry get composition data, dump remote node info fail because no remote_model_list\n");
