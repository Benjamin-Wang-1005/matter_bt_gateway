...
static const group_data_item_t g_wifi_cfg_item_array[] = {
    ...
    NVDM_DATA_ITEM("RxHtBaSize",        "1"),
    NVDM_DATA_ITEM("RxVhtBaSize",       "1"),
    NVDM_DATA_ITEM("RxHeBaSize",        "1"),
    ...
    NVDM_DATA_ITEM("KeepFullPwr",           "0"),
    NVDM_DATA_ITEM("EnterPmInterval_IOTAP", "20"),
    NVDM_DATA_ITEM("Disable11K",        "0"),
    NVDM_DATA_ITEM("Disable11V",        "0"),
    NVDM_DATA_ITEM("AntDivMode",        "3"),
